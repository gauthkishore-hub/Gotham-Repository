...
# ==============================================================================
# Interactive Regression Notebook (interactive_regression.ipynb)
...
# ------------------------------------------------------------------------------
# 7. UNIFIED DASHBOARD LAYOUT
# ------------------------------------------------------------------------------
# Widget Descriptions:
# - dataset: Selects active dataset ('A' or 'B')
# - category: Selects active class (e.g., 'apex')
# - epochs: Sets training iteration count
# - train / evaluate: Runs network optimization or validation batch
# - model path / load / save: Controls PyTorch model file operations (.pth)
# - stop / live: Toggles asynchronous camera loop for continuous inference
